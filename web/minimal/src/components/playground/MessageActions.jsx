      ...
      {!isLoading && (
        ...
        >
          <Button
            ...
            className={`!rounded-full ${shouldDisableActions ? '!text-gray-300 !cursor-not-allowed' : '!text-[var(--semi-color-text-2)] hover:!text-[var(--semi-color-text-0)] hover:!bg-[var(--app-accent-soft)]'} ${styleState.isMobile ? '!w-6 !h-6' : '!w-7 !h-7'} !p-0 transition-all`}
            aria-label={t('重试')}
          />
        </Tooltip>
      )}
      ...
      {message.content && (
        <Tooltip content={t('复制')} position='top'>
          <Button
            ...
            className={`!rounded-full !text-[var(--semi-color-text-2)] hover:!text-[var(--semi-color-text-0)] hover:!bg-[var(--app-accent-soft)] ${styleState.isMobile ? '!w-6 !h-6' : '!w-7 !h-7'} !p-0 transition-all`}
            aria-label={t('复制')}
          />
        </Tooltip>
      )}
      ...
      {canToggleRole && !isLoading && (
        ...
        >
          <Button
            ...
            disabled={shouldDisableActions}
            className={`!rounded-full ${shouldDisableActions ? '!text-gray-300 !cursor-not-allowed' : message.role === 'system' ? '!text-[var(--semi-color-text-0)] hover:!bg-[var(--app-accent-soft)]' : '!text-[var(--semi-color-text-2)] hover:!text-[var(--semi-color-text-0)] hover:!bg-[var(--app-accent-soft)]'} ${styleState.isMobile ? '!w-6 !h-6' : '!w-7 !h-7'} !p-0 transition-all`}
            aria-label={
              message.role === 'assistant'
                ? t('切换为System角色')
                : t('切换为Assistant角色')
